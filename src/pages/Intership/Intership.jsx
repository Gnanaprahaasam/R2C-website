                ...
                <div className='row d-flex justify-content-center g-3'>
                    ...
                    <div className='col-12 col-sm-12 col-md-4 mb-3'>
                        <div className='h-100 rounded-4 shadow p-3 '>
                            ...
                            <div>
                                <h5 className='keyword bold'>For Science Group</h5>
                                <span >We offer internships for Science students. Please click below, </span>
                                <div className='mt-3 '>
                    ...
                    <div className='col-12 col-sm-12 col-md-4 mb-3'>
                        <div className='h-100 rounded-4 shadow p-3 '>
                            ...
                            <h5 className='keyword bold'>For Arts & Business Group</h5>
                            <span >We offer internships for Arts & Business students. Please click below, </span>
                            <div className='mt-3 '>
                                <a href="https://wa.me/+917904189145" target="_blank" rel="noopener noreferrer" class="text-decoration-none ">
                                    <button class="inquire-btn">  <BsWhatsapp size={20} /> Click here to inquire</button>
                                </a>
                    ...
                    <div className='col-12 col-sm-12 col-md-4 mb-3'>
                        <div className='h-100 rounded-4 shadow p-3 '>
                            ...
                            <h5 className='keyword bold'>For Engineering Group</h5>
